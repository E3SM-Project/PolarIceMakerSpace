# ROBERTS_XY2GEODETIC - Convert X and Y coordinates on stereographic grid to lat-long
#
# [lat,lon,SLAT]=roberts_xy2geodetic(X,Y,SGN)
#
...
# -------------------------------------------------------------------------
#
# See also: roberts_geodetic2xy
#
# Code by Andrew Roberts and Travis Davis December 2017
# Department of Oceanography, Naval Postgraduate School

import numpy as np
import scipy

def roberts_xy2geodetic(X, Y, SGN):
    
    # set defaults
    E2 = 0.006693883
    E = np.sqrt(E2)     # eccentricity of Hughes ellipsoid
    RE = 6378.273       # mean earth radius in km
