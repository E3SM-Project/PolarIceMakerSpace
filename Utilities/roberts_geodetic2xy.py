# ROBERTS_GEODETIC2XY - Convert lat-long to X and Y coordinates on a stereographic grid
#
# [X,Y,SLAT,K]=roberts_geodetic2xy(lat,lon,SGN)
#
...
#
# See also: roberts_xy2geodetic
#
# Converted by Travis Davis and Andrew Roberts December 2017
...
def roberts_geodetic2xy(lat, lon, SGN):
